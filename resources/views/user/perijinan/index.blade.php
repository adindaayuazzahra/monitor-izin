...
<div class="hero-container" style="background-image: url({{ asset('assets/img-jmtm/gambar1.jpg') }})">
    ...
    <div class="container align-items-center justify-content-center d-flex" style="padding-top: 90px; ">
        <div class="text-white text-center">
            <h1>e-Legal</h1>
            <p>Selamat datang di aplikasi Monitoring Perijinan dan Dokumen Akta milik<strong> PT Jasamarga Tollroad Maintenance</strong></p>
        </div>
    </div>
</div>
...
<section style="margin-left:30px; margin-right:30px; margin-top:-80px; margin-bottom:50px;">
    ...
    <div class="card shadow mt-5" style="border-radius: 36px;border:none;">
        <div class="d-flex align-items-center  text-white" style="margin:10px;border-radius:35px;padding:18px;background-color:#342073;">
        ...
        <div class="card" style="margin:10px 30px 30px 30px; background-color: transparent;border: none;">
            ...
            <table id="my_table" class="my_table table w-100">
                ...
                <tbody>
                    ...
                    // Menghitung 3 bulan
                    $tigabulan = 0;
                    for ($i = 1; $i <= 3; $i++) { $date=$now->copy()->addMonths($i);
                            ...
                            <td>
                                <a class="
                                                @if (!$p->tanggal_berakhir) @else
                                                    ...
                                                    @endif
                                                @endif
                                            link-offset-2 link-body-emphasis link-underline link-underline-opacity-0 icon-link icon-link-hover" style="--bs-icon-link-transform: translate3d(0, -.200rem, 0);" href="{{ route('perijinan.detail', ['id' => $p->id]) }}">Lihat
                            ...
                            <td>
                                <a class="
                                                @if (!$lisensi->tanggal_berakhir) @else
                                                    ...
                                                    @endif
                                                @endif
                                            link-offset-2 link-body-emphasis link-underline link-underline-opacity-0 icon-link icon-link-hover" style="--bs-icon-link-transform: translate3d(0, -.200rem, 0);" href="{{ route('perijinan.detail', ['id' => $lisensi->id]) }}">Lihat
                                    Detail <i class="bi bi-arrow-up-right-square"></i></a>
                            ...
                            <td>
                                <a class="
                                                @if (!$lifetime->tanggal_berakhir) @else
                                                    ...
                                                    @endif
                                                @endif
                                            link-offset-2 link-body-emphasis link-underline link-underline-opacity-0 icon-link icon-link-hover" style="--bs-icon-link-transform: translate3d(0, -.200rem, 0);" href="{{ route('perijinan.detail', ['id' => $lifetime->id]) }}">Lihat
                                    Detail <i class="bi bi-arrow-up-right-square"></i></a>
                            ...
                            <td>
                                <a class="
                                                @if (!$pros->tanggal_berakhir) @else
                                                    ...
                                                    @endif
                                                @endif
                                            link-offset-2 link-body-emphasis link-underline link-underline-opacity-0 icon-link icon-link-hover" style="--bs-icon-link-transform: translate3d(0, -.200rem, 0);" href="{{ route('perijinan.detail', ['id' => $pros->id]) }}">Lihat
                                    Detail <i class="bi bi-arrow-up-right-square"></i></a>
                            ...
                            <td>
                                <a class="
                                                @if (!$warning->tanggal_berakhir) @else
                                                    ...
                                                    @endif
                                                @endif
                                            link-offset-2 link-body-emphasis link-underline link-underline-opacity-0 icon-link icon-link-hover" style="--bs-icon-link-transform: translate3d(0, -.200rem, 0);" href="{{ route('perijinan.detail', ['id' => $warning->id]) }}">Lihat
                                    Detail <i class="bi bi-arrow-up-right-square"></i></a>
                            ...
                            <td>
                                <a class="
                                                @if (!$non->tanggal_berakhir) @else
                                                    ...
                                                    @endif
                                                @endif
                                            link-offset-2 link-body-emphasis link-underline link-underline-opacity-0 icon-link icon-link-hover" style="--bs-icon-link-transform: translate3d(0, -.200rem, 0);" href="{{ route('perijinan.detail', ['id' => $non->id]) }}">Lihat
                                    Detail <i class="bi bi-arrow-up-right-square"></i></a>
                            </td>
                            {{-- @endif --}}
                        </tr>
